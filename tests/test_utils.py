...
LABEL_SHAPES = [
    ("S1", "S1_B_O2_600_400_25",           "O2 | 400-600 °C"),
    ("S1", "S1_B_Ar_600_400_25",           "Ar | 400-600 °C"),
    ("S1", "S1_B_Ar-80_O2-20_600_400_25",  "Ar-80 O2-20 | 400-600 °C"),
    ("S1", "S1_B_Ar-100_O2-0,25_600_400_25", "Ar-100 O2-0,25 | 400-600 °C"),
    ("S2", "S2_O2_600_400_25",             "O2 | 400-600 °C"),
    ("S2", "S2_Ar-100_600_400_25",         "Ar-100 | 400-600 °C"),
    ("LONG_SAMPLE_ID", "LONG_SAMPLE_ID_B_N2_700_300_50", "N2 | 300-700 °C"),
]
...
@pytest.mark.parametrize("sample_id,condition,expected", [
    ("S1_Tvar", "S1_B_Air_600_400_25",   "Air | 400-600 °C"),
    ("S2_Tvar", "S2_Air_600_400_25",     "Air | 400-600 °C"),
    ("S1_run2", "S1_B_O2_600_400_25",    "O2 | 400-600 °C"),
])
...
def test_air_is_a_gas_not_a_bank_letter() -> None:
    ...
    assert condition_label("S1_Air_600_400_25", "S1") == "Air | 400-600 °C"
...
def test_a_sample_id_sharing_no_prefix_leaves_the_name_alone() -> None:
    ...
    assert condition_label("S1_B_O2_600_400_25", "Unrelated") == "B O2 | 400-600 °C"
...
def test_a_two_letter_gas_is_not_mistaken_for_a_bank_letter() -> None:
    assert condition_label("S1_H2_600_400_25", "S1") == "H2 | 400-600 °C"
