...
$\theta = (R_0?, R_1, \tau_1, \alpha_1, \dots, R_N, \tau_N, \alpha_N)$.
...
and $\tau$ log-uniform inside their windows ($\alpha$ uniform). Restart draws use a
...
channel is stored as $\sigma_0 = 0$, $E_\text{a} = $ NaN.
